...
export default function Details() {
  ...
  const fetchNft = async () => {
    ...
    const options = {
      method: "GET",
      headers: { "X-API-KEY": "dec6fe4199964cc7990875fb6c623441" },
    };
    let url = `https://api.opensea.io/api/v1/asset/0x565AbC3FEaa3bC3820B83620f4BbF16B5c4D47a3/${id}/?include_orders=false`;
  ...
  const fetchCurrentPrice = async () => {
    ...
    let url = `https://api.opensea.io/api/v1/asset/0x565abc3feaa3bc3820b83620f4bbf16b5c4d47a3/${id}/listings?limit=1`;
