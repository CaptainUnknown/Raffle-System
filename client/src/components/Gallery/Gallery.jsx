...
export default function Gallery() {
  ...
  useEffect(() => {
    ...
    let url =
      ...
      idArr.join("") +
      `collection_slug=whoopsies&order_direction=desc&asset_contract_address=0x646Eb9B8E6bED62c0e46b67f3EfdEF926Fb9D621&limit=${num}&include_orders=false`;
  ...
  return (
    <>
      {!mobile.matches && (
        <div id="gallery" className={styles.titleContainer}>
          <h2>GALLERY</h2>
        </div>
      )}
      {mobile.matches && (
