...
import { ReactComponent as MagicEden } from "../../assets/icons/magicEden.svg";
    ...
    <>
      <nav className={styles.navBarContainerActive}>
        <div className={styles.navItemContainer}>
          ...
          <Link to="/raffle" className={styles.navItem}>RAFFLE</Link>
          <Link to="/dashboard" className={styles.navItem}>DASHBOARD</Link>
          <Link to="/claim" className={styles.navItem}>CLAIM</Link>
          <Link to="/faq" className={styles.navItem}>FAQ</Link>
          {/*
          <a
              className = {styles.navItem}
                href="https://www.claimdoop.com/"
                target="_blank"
        ...
        <div className={styles.actionContainer}>
          <a
              href="https://magiceden.io/collections/ethereum/0x646eb9b8e6bed62c0e46b67f3efdef926fb9d621"
              target="_blank"
          ...
          <>
            ...
            <div className={styles.sideBar}>
              <div className={styles.mobileLinks}>
                ...
                <Link to="/claim" className={styles.navItem}>
                  CLAIM
                </Link>
