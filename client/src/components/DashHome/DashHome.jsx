...
export default function DashHome() {
  ...
  const fetchFloorItems = async () => {
    ...
    let url =
      ...
      idArr.join("") +
      `collection_slug=whoopsies&order_direction=desc&asset_contract_address=0x646Eb9B8E6bED62c0e46b67f3EfdEF926Fb9D621&limit=30&include_orders=true`;
  ...
  const getCollectionStats = async () => {
    ...
    fetch("https://api.opensea.io/api/v1/collection/whoopsies/stats", options)
      .then((response) => response.json())
        ...
        <div className={styles.floorItemsContainer}>
          {floorItems.map((item, idx) => (
            <div className={styles.whoopCard} key={idx}>
              ...
              <div className={styles.itemDetails}>
                <a
                  href={`https://opensea.io/assets/ethereum/0x646Eb9B8E6bED62c0e46b67f3EfdEF926Fb9D621/${item.token_id}`}
                  target="_blank"
